...
//
// class TodayFollowUpScreen extends GetView<TodayFollowUpScreenController> {
...
//                     items: controller.viewtodayFollowupDataList.value.data!,
...
//                                     children: [
//                                       CustomText(
//                                         data: person.alternateMobile == null
//                                             ? ""
//                                             : person.alternateMobile.toString(),
//                                         fontSize: 18.sp,
//                                         fontWeight: FontWeight.w500,
...
//                 }),
//                 child: controller
//                             .viewtodayFollowupDataList.value.data?.length ==
//                         null
//                     ? ListView.builder(
//                         itemCount: 1,
...
//                         itemBuilder: (context, index) {
//                           String apiDate =
//                               "${controller.viewtodayFollowupDataList.value.data![index].updatedate}";
//
//                           DateTime dateString = DateTime.parse(apiDate);
//                           String folloupDate =
...
//                             onTap: () {
//                               Get.toNamed(
//                                   AppRoutesName.followup_Screen_Details,
//                                   arguments: [
//                                     controller.viewtodayFollowupDataList.value
//                                                 .data?[index].contactname ==
//                                             null
//                                         ? ""
//                                         : controller.viewtodayFollowupDataList
//                                             .value.data![index].contactname
//                                             .toString(),
//                                     controller.viewtodayFollowupDataList.value
...
//                                             .toString(),
//                                     controller.viewtodayFollowupDataList.value
//                                                 .data?[index].curruntAddrs ==
//                                             null
//                                         ? ""
//                                         : controller.viewtodayFollowupDataList
//                                             .value.data![index].curruntAddrs
//                                             .toString(),
//                                     controller.viewtodayFollowupDataList.value
//                                                 .data?[index].orgAddress ==
//                                             null
//                                         ? ""
//                                         : controller.viewtodayFollowupDataList
//                                             .value.data![index].orgAddress
//                                             .toString(),
//                                     controller
//                                                 .viewtodayFollowupDataList
//                                                 .value
...
//                                         ? ""
//                                         : controller.viewtodayFollowupDataList
//                                             .value.data![index].alternateEmail
//                                             .toString(),
//                                     controller.viewtodayFollowupDataList.value
...
//                                             .toString(),
//                                     controller.viewtodayFollowupDataList.value
//                                                 .data?[index].lSubstatus ==
//                                             null
//                                         ? ""
//                                         : controller.viewtodayFollowupDataList
//                                             .value.data![index].lSubstatus
//                                             .toString(),
//                                     controller.viewtodayFollowupDataList.value
//                                                 .data?[index].leadsId ==
//                                             null
...
//                                             onTap: () {
//                                               launch(
//                                                   "tel://${controller.viewtodayFollowupDataList.value.data?[index].lMobile == null ? "" : controller.viewtodayFollowupDataList.value.data![index].lMobile.toString()}");
//                                             },
//                                             child: Container(
//                                               height: 25.h,
//                                               width: 34.w,
...
//                                             onTap: () {
//                                               launch(
//                                                   "tel://${controller.viewtodayFollowupDataList.value.data?[index].alternateMobile == null ? "" : controller.viewtodayFollowupDataList.value.data![index].alternateMobile.toString()}");
//                                             },
//                                             child: Container(
//                                               height: 25.h,
//                                               width: 34.w,
...
//                                                                 Map data =
//                                                                 {
//                                                                   "LeadsId": controller.viewtodayFollowupDataList.value.data?[index].leadsId == null
//                                                                       ? ""
//                                                                       : controller.viewtodayFollowupDataList.value.data![index].leadsId.toString(),
//                                                                   "LSubstatus": controller.viewtodayFollowupDataList.value.data?[index].lSubstatus == null
//                                                                       ? ""
//                                                                       : controller.viewtodayFollowupDataList.value.data![index].lSubstatus.toString(),
//                                                                   "LAction":
