...
var targetMap = map[string]esbuild.Target{
	"node22.x": esbuild.ES2022,
	"node20.x": esbuild.ES2020,
	"node18.x": esbuild.ES2018,
	"node16.x": esbuild.ES2016,
	"node14.x": esbuild.ES2015,
	"node12.x": esbuild.ES2015,
}
...
func (r *Runtime) Build(ctx context.Context, input *runtime.BuildInput) (*runtime.BuildOutput, error) {
	...
	options := esbuild.BuildOptions{
		...
		Target:      targetMap[properties.Target],
	...
	if !isESM {
		...
		options.Target = targetMap[properties.Target]
