...
- **Containers**
  ...
  This applies a ployfill to the `console` object to prepend the log lines with a marker that allows Issues to detect errors. [More on this below](#how-it-works-1).
